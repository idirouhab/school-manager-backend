...
exports.updateExamAnswers = (examId, answerId) => {
    return Exam.findOneAndUpdate({ "_id": examId }, { "$push": { "answers": answerId } }, { new: true });
};
...
exports.update = (id, data) => {
    return Exam.findByIdAndUpdate(id, data, { useFindAndModify: false });
};
exports.updateOne = (filter, data) => {
    return Exam.findOneAndUpdate(filter, data, { useFindAndModify: false });
};
exports.delete = (id) => {
